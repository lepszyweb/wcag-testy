...
------------------------------
-   Testowanie zsynchronizowanych multimediów różni się od testów podstawowych [16. Tylko audio i tylko wideo](16_TylkoAudioTylkoWideo.md).
...
----------------------------------------
[Początek/Spis treści](index.md) | [Poprzedni](16_TylkoAudioTylkoWideo.md) | [[Następny]](18_ZaleznoscOdCSS.md)
