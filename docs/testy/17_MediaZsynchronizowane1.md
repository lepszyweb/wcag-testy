...
**Uwaga**: w *ICT Testing Baseline* multimedia zsynchronizowane są testowane pod kątem kryterium sukcesu 1.2.5 (Poziom A). Kryterium sukcesu nie jest testowane. Na wyższym poziomie zgodności (AA) KS 1.2.5 wymaga opisów dźwiękowych i jest bardziej restrykcyjne. 



## Procedura testu dla Section 508 503.4

### Identyfikacja treści
Odtwarzacz multimedialny, który wyświetla wideo ze zsynchronizowanym dźwiękiem.

### Instrukcja testowania
1.  Sprawdź, czy dostępne są kontrolki umożliwiające użytkownikowi wybór napisów i opisów dźwiękowych.

### Wynik testów
If any of the above checks fail, Section 508 503.4 and Baseline Requirement 17 fail.

## Procedura testu dla Section 508 503.4.1

### Identyfikacja treści
Odtwarzacz multimedialny, który wyświetla wideo ze zsynchronizowanym dźwiękiem i ma regulację głośności.

### Instrukcja testowania
1.  Sprawdź, czy elementy sterujące do wyboru napisów znajdują się na tym samym poziomie menu, co elementy sterujące ustawieniem głośności lub wyboru programu.


### Wynik testów
If any of the above checks fail, Section 508 503.4.1 and Baseline Requirement 17 fail.

## Procedura testu dla Section 508 503.4.2

### Identyfikacja treści
Odtwarzacz multimedialny, który wyświetla wideo ze zsynchronizowanym dźwiękiem i ma kontrolę wyboru programu.

### Instrukcja testowania
1.  Sprawdź, czy elementy sterujące wyborem opisów dźwiękowych znajdują się na tym samym poziomie menu, co elementy sterujące ustawieniem głośności lub wyborem programu.
