...
-------------------------------------
[Baza testów wstępnych. Wprowadzenie &lt; Poprzednia strona](testy/00_P_wprowadzenie.md) | [Następna strona &gt; Teksty alternatywne obrazów](testy/02_P_odpowiedniki-tekstowe-obrazow.md)