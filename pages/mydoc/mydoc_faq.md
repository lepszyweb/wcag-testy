...
summary: "Możesz użyć układu akordeonu, który wykorzystuje styl Bootstrap. Jest to przydatne na stronie FAQ."
toc: false
folder: mydoc
---

<p>Jeśli chcesz użyć formatu FAQ, skorzystaj ze składni pokazanej na stronie faq.html. Zamiast divdołączać tutaj próbki kodu (które są nieporęczne z dużą ilością zagnieżdżonych znaczników), po prostu spójrz na źródło w pliku motywu mydoc_faq.html.</p>
