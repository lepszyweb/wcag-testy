...
Odtwarzacz multimedialny, który wyświetla wideo ze zsynchronizowanym dźwiękiem.
...
### Wynik testów
Jeśli którykolwiek z powyższych testów zakończy się niepowodzeniem, test podstawowy _17.A-MediaPlayerCCADControls_ również kończy się niepowodzeniem.
...
### Identyfikacja treści
Odtwarzacz multimedialny, który wyświetla wideo ze zsynchronizowanym dźwiękiem i ma elementy sterujące regulacją głośności.
...
### Wynik testów
Jeśli którykolwiek z powyższych testów zakończy się niepowodzeniem, test podstawowy _17.B-MediaPlayerCCLevel_ również kończy się niepowodzeniem.
...
### Identyfikacja treści
Nagrane multimedia zsynchronizowane. Nie uwzględniaj multimediów, które są wyraźnie oznaczone jako alternatywa dla tekstu.

### Instrukcja testowania
1.  Sprawdź, czy istnieją napisy rozszerzone
2.  Włącz napisy rozszerzone za pomocą funkcji odtwarzacza multimedialnego i odtwarzaj multimedia. Jeśli dostarczono osobny plik multimedialny z napisami, przetestuj ten plik.
...
### Wynik testów
Jeśli którykolwiek z powyższych testów zakończy się niepowodzeniem, test podstawowy _17.D-CaptionsPrerecorded_ również kończy się niepowodzeniem.
...
2.  Sprawdź, czy napisy rozszerzone zawierają dialogi i informacje o ważnych dźwiękach.
    -  Przesłuchaj dźwięk z całego zsynchronizowanego medium.
...
### Wynik testów
Jeśli którykolwiek z powyższych testów zakończy się niepowodzeniem, test podstawowy _17.F-CaptionsLive_ również kończy się niepowodzeniem.
...
### Identyfikacja treści
Nagrane zsynchronizowane multimedia, które są wyraźnie oznaczone jako alternatywa dla tekstu.
...
### Wynik testów
Jeśli którykolwiek z powyższych testów zakończy się niepowodzeniem, oznacza to, że multimedia nie jest alternatywą medialną dla tekstu. Wykonaj procedurę testową testu podstawowego 17.D Procedura testowa dla napisów rozszerzonych (nagranie) i procedurę testową 17.E Procedura testu dla audiodeskrypcji (nagranie).
...
- {% include techniki/F74.md %}
- {% include techniki/F75.md %}