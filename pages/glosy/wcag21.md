...
WCAG 2.1 są [Rekomendacją W3C](https://www.w3.org/2018/Process-20180201/#RecsW3C) opracowaną przez [Web Content Accessibility Guidelines Working Group](http://www.w3.org/WAI/GL/) (Grupę Roboczą ds. Wytycznych dla dostępności treści internetowych).
...
Ten dokument został opublikowany przez [Accessibility Guidelines Working Group](https://www.w3.org/WAI/GL/) (Grupę Roboczą Wytyczncy dla Dostępności) jako rekomendacja.
...
Wszystkie powyższe warstwy (zasady, wytyczne, kryteria sukcesu, techniki wystarczające i&nbsp;dodatkowe) uzupełniają się wzajemnie i&nbsp;wskazują, w jaki sposób tworzyć bardziej dostępne treści internetowe. Wykonawcom i&nbsp;autorom treści doradza się stosowanie w miarę możliwości wszystkich warstw, w&nbsp;tym także technik dodatkowych, aby zaspokoić potrzeby jak najszerszej grupy użytkowników. Należy pamiętać, że nawet treści, która są zgodne najwyższym (AAA) poziomie, nie będą dostępne dla osób ze wszystkimi rodzajami i&nbsp;stopniami niepełnosprawności, czy też z niepełnosprawnością złożoną, szczególnie w zakresie problemów z uczeniem się oraz zrozumieniem języka.
...
### Interpretacja wymagań normatywnych
...
5. **Brak zakłóceń**: Jeśli na stronie wykorzystywane są technologie, które nie obsługują dostępności lub są użyte tak, że nie obsługują dostępności, to technologie te nie blokują użytkownikom dostępu do reszty strony. Dodatkowo, <a href="#" data-toggle="tooltip" data-original-title="{{site.data.glossary.strona_internetowa | strip_html | replace: '*', ''}}">strona internetowa</a> jako całość nadal spełnia wymogi zgodności pod każdym z następujących warunków:
...
### Oświadczenie o zgodności (opcjonalne)
...
#### Wymagane elementy oświadczenia o zgodności
...
#### Opcjonalne składniki oświadczenia o zgodności
...
### Oświadczenie o częściowej zgodności – treść umieszczana przez dostawców zewnętrznych
